...
from app.schemas.chunk import ChunkingConfig, ChunkVisualization
...
class SemanticChunker:
    ...
    def _ensure_model_loaded(self):
        ...
        if SemanticChunker._model_instance is None:
            ...
            try:
                ...
                raise AppException(500, f"Failed to load embedding model: {str(e)}")
    ...
    def chunk(self, text: str, config: ChunkingConfig) -> List[dict]:
        ...
        for i in range(n_sims):
            ...
            # Also allow split if it's REALLY low (e.g. < 0.2) regardless of valley, 
            # to handle long sections of low similarity? 
            # For now, let's stick to valley logic + threshold constraint.
            # If everything is [0.4, 0.4, 0.4] and thresh=0.5, is_valley is True for all.
            # So it behaves like strict thresholding on plateaus. Correct.
            ...
            # Force split if sim is extremely low (safety net)? 
            # No, trusting valley logic.
