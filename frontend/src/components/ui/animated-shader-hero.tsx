...
void main(){gl_Position=position;}`;
    ...
    const loop = (now: number) => {
        ...
        rendererRef.current.updatePointerCount(pointersRef.current.pointerCount);
      ...
      `}</style>
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white pointer-events-none">
                ...
                <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600 pointer-events-auto">
